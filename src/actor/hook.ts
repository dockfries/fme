...
import { g_SelectActListData, g_SelectListPTD, MAX_SELECT_LIST_ROWS } from "@/selectList";
...
function hook_CreateActor(modelId: number, x: number, y: number, z: number, rotation: number) {
